      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className={`text-xs m-0 ${
            ...
            Configure pricing for your branch. These are the services you can create, update, and delete.
          </p>
        </div>
      </div>
      {isLoading ? (
        ...
        <div className="py-6 text-center">
          ...
          <p className={`text-xs m-0 ${
            ...
            Browse categories → subcategories → templates to create your first service configuration.
          </p>
        </div>
      ) : (
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-3 items-center mb-2">
                  <span className={`text-sm ${
                    ...
                    Price/Unit: <strong className={theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}>
                      ₵{service.pricePerUnit.toFixed(2)}
                    </strong>
                  </span>
                  {service.constant !== null && service.constant !== undefined && (
                    <span className={`text-sm ${
                      theme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                    }`}>
                      Constant: <strong className={theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}>
                        {service.constant}
                      </strong>
                    </span>
                  )}
