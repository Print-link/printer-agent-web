...
export function ManagerCategoryAnalytics({
  ...
  return (
    <div className={`p-3 sm:p-4 md:p-6 rounded-md border ${
      theme === 'dark' ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
    }`}>
      <h2 className={`text-lg sm:text-xl font-bold mb-4 sm:mb-6 flex items-center gap-2.5 m-0 ${
          ...
          >
            <div className="flex gap-2 sm:gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <h3 className={`font-semibold mb-1 sm:mb-2 text-sm sm:text-base leading-tight truncate ${
                  theme === 'dark' ? 'text-gray-100' : 'text-gray-900'
                }`}>
                  {cat.categoryName}
                </h3>
            ...
            <div className={`grid grid-cols-2 gap-2 sm:gap-3 pt-3 border-t ${
              ...
              <div>
                <div className={`text-[10px] sm:text-[11px] mb-0.5 sm:mb-1 font-medium ${
            ...
            {cat.orderItemsCount > 0 && (
              <div className={`mt-3 pt-3 border-t text-xs ${
                ...
                <strong className={theme === 'dark' ? 'text-gray-100' : 'text-gray-900'}>
                  Order Items:
                </strong>{' '}
