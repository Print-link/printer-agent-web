...
import { User, Mail, Lock, MapPin, Calendar, LogOut, Edit, Save, X, Key } from 'lucide-react';
          ...
          {isEditingProfile ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <Calendar className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} size={18} />
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <MapPin className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} size={18} />
