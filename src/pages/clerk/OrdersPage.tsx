...
export default function OrdersPage() {
  ...
  const { data: orders = [], isLoading, error, refetch } = useQuery({
    ...
    queryFn: async () => {
      if (!branchId) {
        throw new Error(user?.role === 'clerk' 
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden gap-0 min-h-0 flex-col lg:flex-row">
        ...
        <div className={`${
          ...
          selectedOrder ? `border-b lg:border-b-0 lg:border-r ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'}` : ''
        }`}>
          ...
          <div className="flex-1 flex flex-col overflow-hidden min-w-0 w-full lg:w-auto">
            <OrderDetailPreview
              ...
              onOrderUpdate={() => {
                ...
                queryClient.invalidateQueries({ queryKey: ['orderDetail', selectedOrder.id] });
                refetch();
              }}
            />
          </div>
